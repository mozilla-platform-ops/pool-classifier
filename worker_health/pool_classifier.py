...
class PoolClassifier:
    ...
    def _write_html(
        ...
        parts += [
            ...
            '<p id="source-freshness" class="gen">Loading job sources…</p><div id="source-chart" class="source-chart" role="group" aria-label="Daily job volume by source"></div><div id="source-tooltip" class="source-tooltip" role="tooltip" aria-hidden="true"></div>',
