...
class PoolClassifier:
    ...
    def _write_html(
        ...
        parts = [
            ...
            "  .page-nav { display: flex; align-items: center; gap: 0; flex-wrap: wrap; width: fit-content; margin: 0 0 1.5rem 1ch; padding: .3rem .6rem .3rem 0; background: #1a1a1a; border-radius: 4px; font-size: .8em; }",
