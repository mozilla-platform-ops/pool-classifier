...
class PoolClassifier:
    ...
    def _write_html(
        ...
        parts = [
            ...
            "  .lag-hm-label { color:#777; font-size:.72em; text-align:center; } .lag-hm-day { text-align:left; padding-right:.2rem; align-self:center; } .lag-hm-cell { height:1rem; border:0; border-radius:2px; cursor:default; outline:1px solid #111; } .lag-hm-cell.insufficient { background:repeating-linear-gradient(135deg,#333 0,#333 4px,#222 4px,#222 8px) !important; } .lag-hm-cell:hover { filter:brightness(1.25); outline-color:#aaa; } .lag-hm-cell.lag-linked-hover { outline:2px solid #fff; filter:brightness(1.35); position:relative; z-index:1; }",
            "</style>",
            "</head>",
            "<body>",
